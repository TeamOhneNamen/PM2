...
public class ComplexTest {
	...
	@Test
	public final void testOf_Cartesian() {
	...
	public final void testInvert() {
		...
		assertNotEquals(com1.invert(), new Complex(3,4));
		assertEquals(rational.invert(), new Complex(-3,0));
		assertEquals(com_zero.invert(), com_zero);
	}

	@Test
	public final void testSetKonj() {
		assertEquals(com1.setKonj(), new Complex(3,-4));
		assertNotEquals(com2.setKonj(), new Complex(-3,4));
		assertNotEquals(com3.setKonj(), new Complex(-5,-3));
		assertEquals(rational.setKonj(), new Complex(3,0));
		assertEquals(com_zero.setKonj(), new Complex(0,0));
	}
	...
	public final void testRational() {
		assertEquals(3, rational.rational(), DELTA);
		assertEquals(0, com_zero.rational(), DELTA);
		assertEquals(3, com1.setRational().rational(), DELTA);
		assertNotEquals(3, com3.setRational().rational(), DELTA);
	}
	...
	public final void testGetReal() {
		...
		assertNotEquals(3, com1.invert().getReal(), DELTA);
	...
	public final void testGetImag() {
		...
		assertNotEquals(4, com1.invert().getImag(), DELTA);
	...
	public final void testAdd() {
		...
		assertEquals(9.0, com1.add(com_add1).getImag(), DELTA);

		// com1 + com_add2
		assertEquals(5.345, com1.add(com_add2).getReal(), DELTA);
		assertEquals(9.4321, com1.add(com_add2).getImag(), DELTA);
	}
	...
	public final void testSub() {
		...
		assertEquals(-4.0, com1.sub(com_sub1).getImag(), DELTA);

		// com1 + com_sub2
		assertEquals(0.655, com1.sub(com_sub2).getReal(), DELTA);
		assertEquals(-4.4321, com1.sub(com_sub2).getImag(), DELTA);
	}
	...
	public final void testMult() {
		...
		assertEquals(37, com1.mult(com_mult1).getImag(), DELTA);

		// com1 * com_mult2
		assertEquals(-35.3, com1.mult(com_mult2).getReal(), DELTA);
		assertEquals(-20.4, com1.mult(com_mult2).getImag(), DELTA);
	}
	...
	public final void testDiv() {
		...
		assertEquals(0.482, com1.div(com_div1).getImag(), 0.001);

		// com1 * com_div2
		assertEquals(-0.338, com1.div(com_div2).getReal(), 0.001);
		assertEquals(-0.451, com1.div(com_div2).getImag(), 0.001);
	}
	...
	public final void testSquare() {
		...
		assertEquals(24, com1.square().getImag(), DELTA);
		
		assertEquals(com_square, com1.square().square());
		assertEquals(com_square, com1.square().square());

		assertEquals(com_doublesquare.getReal(), com_square.square().getReal(), DELTA);
		assertEquals(com_doublesquare.getImag(), com_square.square().getImag(), DELTA);
	}
	
	@Test
	public final void testPow() {
		assertEquals(com1.pow(2), com1.square());
		assertEquals(com1.pow(2), com1.mult(com1));
		assertEquals(com1.pow(3), com1.mult(com1.mult(com1)));
		assertNotEquals(com1.pow(3), com1.square());
	}
